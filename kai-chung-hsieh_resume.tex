...
\section{EDUCATION}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Summer vacation training in the SOC lab implementing a pre-synthesis 5-stage pipeline ARM processor by Verilog}
  \resumeSubHeadingListEnd
  \vspace{-16pt}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItem{Independent study on VLSI design automation, the topic: Rectilinear Steiner Routing Problem with Obstacles in Multiple Layers}
      \resumeItemListEnd
